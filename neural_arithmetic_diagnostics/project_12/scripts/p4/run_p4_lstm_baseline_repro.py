"""
================================================================================
RUN_P4_LSTM_BASELINE_REPRO.PY
================================================================================

PROJECT 12 BASELINE REPRODUCTION ENTRYPOINT — LSTM

PURPOSE:
  Reproduce Project 4 LSTM baseline evaluation in Project 12 using manifest-driven
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Project 12 Project 4 LSTM baseline reproduction"
    )
    parser.add_argument(
        "--manifest",
        type=str,
...
def main():
    ...
    print_header("PROJECT 12 — PROJECT 4 LSTM BASELINE REPRODUCTION")
    ...
    scorecard = build_scorecard(
        ...
        tags=["project4", "phase30", "lstm", "aligned_eval_path", "p12_repro"],
    )
    ...
    report_text = f"""# PROJECT 12 — PROJECT 4 LSTM BASELINE REPRODUCTION REPORT
