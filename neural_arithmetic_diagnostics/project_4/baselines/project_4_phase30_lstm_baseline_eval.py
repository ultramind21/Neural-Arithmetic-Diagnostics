"""
================================================================================
PROJECT 4 PHASE-30 LSTM BASELINE EVALUATION
================================================================================

PURPOSE:
  Execute the Phase 30 LSTM baseline evaluation path under Project 4 using
...
def parse_args():
    parser = argparse.ArgumentParser(description="Project 4 Phase30 LSTM baseline evaluation")
    parser.add_argument("--model-name", type=str, default="phase30_lstm_baseline")
...
def main():
    ...
    print_header("PROJECT 4 PHASE-30 LSTM BASELINE EVALUATION (ALIGNED PATH)")
    ...
    scorecard = build_scorecard(
        ...
        tags=["project4", "phase30", "lstm", "aligned_eval_path"],
    )
