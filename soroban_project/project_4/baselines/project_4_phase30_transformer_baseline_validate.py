"""
================================================================================
PROJECT 4 PHASE-30 TRANSFORMER BASELINE VALIDATION RUNNER
================================================================================

PURPOSE:
  Run repeated Phase-30 Transformer baseline evaluations under Project 4 and
  aggregate them into a single validation artifact suitable for stability checking.

ROLE:
  This script:
    - reuses the trained Transformer checkpoint
...
BASELINE_EVAL_MODULE = "project_4.baselines.project_4_phase30_transformer_baseline_eval"

RESULTS_DIR = PROJECT_4_ROOT / "results" / "baseline_runs"
VALIDATION_OUTPUT = RESULTS_DIR / "phase30_transformer_validation_runs.json"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Project 4 Phase-30 Transformer baseline validation runner")
...
def main():
    ...
    print_header("PROJECT 4 PHASE-30 TRANSFORMER BASELINE VALIDATION RUNNER")
    ...
    for run_idx in range(args.runs):
        ...
        model_name = f"phase30_transformer_baseline_run{run_idx}"

        import sys
        sys.argv = [
            "project_4_phase30_transformer_baseline_eval",
        ...
        try:
            from project_4.baselines.project_4_phase30_transformer_baseline_eval import main as baseline_main
            baseline_main()
    ...
    validation_payload = {
        "status": "project4_phase30_transformer_validation_runs",
        "checkpoint": args.checkpoint,
        "run_count": args.runs,
        ...
        "notes": [
            ...
            "It aggregates repeated aligned Phase 30 Transformer Project 4 baseline runs",
