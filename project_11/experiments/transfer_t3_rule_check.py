...
def predict_by_rule_v3(system: dict, H: float, P: float) -> str:
    # Rule V3 (system-aware, no base, no clamp)
...
def main():
    ...
    print("\n=== TRANSFER T3 — RULE V3 COMPLIANCE CHECK ===")
    ...
    if mismatches:
        ...
        for m in mismatches[:10]:
            print(m)
        raise SystemExit("FAIL: transfer_t3_predictions.json does NOT match Rule V3.")
    else:
