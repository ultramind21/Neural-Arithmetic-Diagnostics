"""
================================================================================
RUN_P4_MLP_BASELINE_REPRO.PY
================================================================================

PROJECT 12 BASELINE REPRODUCTION ENTRYPOINT — MLP

PURPOSE:
  Reproduce Project 4 MLP baseline evaluation in Project 12 using manifest-driven
...
# Import Project 4 baseline components (relative to PROJECT_ROOT)
...
SOURCE_SCRIPT = PROJECT_4_ROOT / "baselines" / "project_4_phase30_mlp_baseline_eval.py"
...
def validate_checkpoint(ckpt_path: Path, device: torch.device) -> Dict[str, Any]:
    ...
    Raises AssertionError if checkpoint cannot be loaded.
    """
    result = {
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Project 12 Project 4 MLP baseline reproduction"
    )
    parser.add_argument(
        "--manifest",
        type=str,
...
def main():
    ...
    print_header("PROJECT 12 — PROJECT 4 MLP BASELINE REPRODUCTION")
    ...
    scorecard = build_scorecard(
        ...
        tags=["project4", "phase30", "mlp", "aligned_eval_path", "p12_repro"],
    )
    ...
    report_text = f"""# PROJECT 12 — PROJECT 4 MLP BASELINE REPRODUCTION REPORT
...
"""
    ...
    write_text(md_path, report_text)
