...
| 6 | Entrypoint Fidelity | Copy+patch discipline (diff gate ≥0.85) | `project_12/reports/DIFF_GATE_P4_INTERVENTION_ENTRYPOINT.md` |
...
| 9 | Evidence Aggregation | Link all claims to reports + artifacts | `project_12/docs/PAPER_READY_PHASE1_EVIDENCE_INDEX.md` |
