# Table 2: Project 11 Evidence Summary (Phase 1)
...
| P11-C03 | ✅ VALIDATED | Mixed@N=1000 vs boundary-only@N=1000 | project_12/results/revalidate_p11proc/phase_e2/ | P11_VALIDATION_REPORT_REVALIDATE_P11PROC.md |
