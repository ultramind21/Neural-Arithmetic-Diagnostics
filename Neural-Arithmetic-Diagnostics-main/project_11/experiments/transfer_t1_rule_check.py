...
def main():
    ...
    for pt in points:
        ...
        if expected != actual:
            mismatches.append((pid, expected, actual, H, P))

    print("\n=== TRANSFER T1 — RULE COMPLIANCE CHECK ===")
    ...
    if mismatches:
        ...
        for m in mismatches[:10]:
            print({"id": m[0], "expected": m[1], "actual": m[2], "H": m[3], "P": m[4]})
        raise SystemExit("FAIL: transfer_t1_predictions.json does NOT match V2 compressed rule.")
    else:
