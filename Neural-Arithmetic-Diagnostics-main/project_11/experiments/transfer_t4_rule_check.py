...
def predict_by_rule_v3(system: dict, H: float, P: float) -> str:
...
def main():
    ...
    if mismatches:
        ...
        for m in mismatches[:10]:
            print(m)
        raise SystemExit("FAIL: transfer_t4_predictions.json does NOT match Rule V3.")
    else:
